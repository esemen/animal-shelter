        ...
        <div class="shell">
            ...
            <div class="tabs tabs-custom tabs-vertical tabs-corporate tabs-wide" id="tabs-1"
                ...
                <ul class="nav nav-tabs">
                    <li><a href="/adopt-a-dog" data-toggle="tab">Adopt Dogs</a></li>
                    <li class="active"><a href="/adopt-a-cat" data-toggle="tab">Adopt Cats</a></li>
                ...
                <div class="tab-content">
                    ...
                    <!-- Tab 2-->
                    <div class="tab-pane fade" id="adopt-cats">
                        <div class="range spacing-30">
                            <div class="cell-xs-12">
                                ...
                                <div class="thumbnail-boxed thumbnail-boxed-horizontal">
                                    <div class="thumbnail-boxed-left"><img class="thumbnail-boxed-image"
                                            src="images/adopt-dogs-1-370x254.jpg" alt="" width="370"
                                            height="254" />
                                    </div>
                                    <div class="thumbnail-boxed-body">
                                        <p class="thumbnail-boxed-title"><a
                                                href="single-page-pets">Beasley</a></p>
                                        <div class="thumbnail-boxed-text">
                                            <p>He was in a shelter that lacked the resources to continue to care
                                                for him, so Beasley came to our shelter to find a new home. He
                                                is playful and cheerful dog, who enjoys playing with toys and
                                                often...</p>
                                        </div>
                                        <div class="thumbnail-boxed-footer">
                                            <ul class="thumbnail-boxed-meta">
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-event_available"></span><span>2.5
                                                        years old</span></li>
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-done"></span><span>42
                                                        pounds</span></li>
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-place"></span><span>New
                                                        York</span></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="cell-xs-12">
                                <!-- Thumbnail boxed horizontal-->
                                <div
                                    class="thumbnail-boxed thumbnail-boxed-horizontal thumbnail-boxed-blue-marguerite">
                                    <div class="thumbnail-boxed-left"><img class="thumbnail-boxed-image"
                                            src="images/adopt-dogs-2-370x254.jpg" alt="" width="370"
                                            height="254" />
                                    </div>
                                    <div class="thumbnail-boxed-body">
                                        <p class="thumbnail-boxed-title"><a
                                                href="single-page-pets">Jade</a></p>
                                        <div class="thumbnail-boxed-text">
                                            <p>Jade needed help with her behavior, so she came to Animal Shelter
                                                to learn good manners and find a new home. She is ready to find
                                                a new home and a loving family. is very positive and emotional,
                                                so...</p>
                                        </div>
                                        <div class="thumbnail-boxed-footer">
                                            <ul class="thumbnail-boxed-meta">
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-event_available"></span><span>12
                                                        years old</span></li>
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-done"></span><span>47
                                                        pounds</span></li>
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-place"></span><span>New
                                                        York</span></li>
                            ...
                            <div class="cell-xs-12">
                                <!-- Thumbnail boxed horizontal-->
                                <div
                                    class="thumbnail-boxed thumbnail-boxed-horizontal thumbnail-boxed-tan-hide">
                                    <div class="thumbnail-boxed-left"><img class="thumbnail-boxed-image"
                                            src="images/adopt-dogs-3-370x254.jpg" alt="" width="370"
                                            height="254" />
                                    </div>
                                    <div class="thumbnail-boxed-body">
                                        <p class="thumbnail-boxed-title"><a
                                                href="single-page-pets">Blake</a></p>
                                        <div class="thumbnail-boxed-text">
                                            <p>Blake was delivered to our shelter after a brutal attack by other
                                                dogs. Our vets helped him to survive the results of this
                                                incident, and now he is ready to be adopted! He is doing very
                                                well with other dogs...</p>
                                        </div>
                                        <div class="thumbnail-boxed-footer">
                                            <ul class="thumbnail-boxed-meta">
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-event_available"></span><span>10
                                                        years old</span></li>
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-done"></span><span>92
                                                        pounds</span></li>
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-place"></span><span>New
                                                        York</span></li>
                            ...
                            <div class="cell-xs-12">
                                ...
                                <div class="thumbnail-boxed thumbnail-boxed-horizontal">
                                    <div class="thumbnail-boxed-left"><img class="thumbnail-boxed-image"
                                            src="images/adopt-dogs-4-370x254.jpg" alt="" width="370"
                                            height="254" />
                                    </div>
                                    <div class="thumbnail-boxed-body">
                                        <p class="thumbnail-boxed-title"><a
                                                href="single-page-pets">Niles</a></p>
                                        <div class="thumbnail-boxed-text">
                                            <p>Niles is a handsome 4-year old Belgian/German shepherd mix
                                                arriving in NYC on November 19 from a high kill shelter in
                                                Alabama. This sweet boy is just waiting to find a forever home
                                                where he can cuddle...</p>
                                        </div>
                                        <div class="thumbnail-boxed-footer">
                                            <ul class="thumbnail-boxed-meta">
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-event_available"></span><span>4.4
                                                        years old</span></li>
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-done"></span><span>64
                                                        pounds</span></li>
                                                <li><span
                                                        class="icon icon-xs icon-black-hide material-icons-place"></span><span>New
                                                        York</span></li>
